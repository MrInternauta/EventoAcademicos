...
{
    public class Academico_EventosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Academico_EventosController(ApplicationDbContext context)
        {
            _context = context;
        }

        // GET: Academico_Eventos
        ...
        // GET: Academico_Eventos/Details/5
        ...
        public async Task<IActionResult> Create([Bind("Id,AcademicoId,EventoId")] Academico_Evento academico_Evento)
        {
            ...
            ViewData["AcademicoId"] = new SelectList(_context.Academico, "Id", "Id", academico_Evento.AcademicoId);
            ViewData["EventoId"] = new SelectList(_context.Evento, "Id", "NombreEvento", academico_Evento.EventoId);
            return View(academico_Evento);
        }

        // GET: Academico_Eventos/Edit/5
        ...
        // GET: Academico_Eventos/Delete/5
        ...
        // POST: Academico_Eventos/Delete/5
