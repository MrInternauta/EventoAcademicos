...
{
    public class Role_UsuariosController : Controller
    {
        private readonly ApplicationDbContext _context;

        public Role_UsuariosController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var permisos = role_Usuario.Usuario.permisos();
            return View(role_Usuario);
        }

        // GET: Role_Usuarios/Create
        ...
        public async Task<IActionResult> Create([Bind("Id,RoleId,UsuarioId")] Role_Usuario role_Usuario)
        {
            ...
            ViewData["RoleId"] = new SelectList(_context.Role, "Id", "Nombre", role_Usuario.RoleId);
            ViewData["UsuarioId"] = new SelectList(_context.Usuario, "Id", "Email", role_Usuario.UsuarioId);
            return View(role_Usuario);
        }

        // GET: Role_Usuarios/Edit/5
